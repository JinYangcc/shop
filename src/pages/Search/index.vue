        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            <li class="with-x" v-if="searchParams.categoryName">
              {{ searchParams.categoryName }}<i @click="removeI">×</i>
            </li>
...
export default {
  ...
  methods: {
    ...
    removeI() {
      //*带给服务器的参数说明可有可无，如果属性值为空的字符串还是会把相应字段带给服务器
      //*但是你把相应字段变为undefined，当前这个字段不会带给服务器
  ...
  watch: {
    $route() {
      ...
      this.searchParams.category2Id = undefined;
      this.searchParams.category3Id = undefined;
      //*整理参数，把query,params 都合并为searchparams
      Object.assign(this.searchParams, this.$route.query, this.$route.params);
      this.getData();
    },
  },
